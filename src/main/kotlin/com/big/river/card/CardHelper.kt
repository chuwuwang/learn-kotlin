...
object CardHelper {
    ...
    const val CARD_JCB = "JCB"
    const val CARD_VISA = "Visa"
    const val CARD_PURE = "Pure"
    const val CARD_INDIAN = "RuPay"
    const val CARD_UNION_PAY = "UnionPay"
    const val CARD_MASTERCARD = "MasterCard"
    const val CARD_AMERICAN_EXPRESS = "AmericanExpress"
